<div class="container">
    <h1 class="well"><center>Pendaftaran Catering</center></h1>
                ...
                <div class="col-sm-12">
                    <div class="row">
                        <div class="col-sm-6 form-group">
                            ...
                            <input type="text" class="form-control" name="fname" placeholder="Masukan nama belakang Anda" value="<?php echo isset($fname) ? $fname : ' ';?>">
                            <span class="text-danger msg-error"><?php echo $fnameErr; ?></span>
                        </div>
                            
                        <div class="col-sm-6 form-group">
                            <label>Nama Belakang :</label>
                            <input type="text" class="form-control" name="lname" placeholder="Masukan nama depan Anda" value="<?php echo isset($lname) ? $lname : ' ';?>">
                    ...
                    <center>
                        <div class="form-group">
                            ...
                            <a href="../sucess.php"><button type="button" class="btn btn-link">Batal</button></a>
                        </div>
                    </center>
