...
<div class="footer-top">
	<div class="container">
		<div class="col-lg-3 footer-grid">
			<h3>Tentang Kami</h3>
			<p>
E catering adalah platform berbasis web yang menyediakan data informasi yang dipakai sebagai tempat bertemunya penjual dan pembeli dalam bidang makanan / katering.
</p>
		</div>
		<div class="col-lg-3 footer-grid">
			<h3>Menu</h3>
...
<div class="footer-bottom">
	<div class="container-fluid">
		...
		<p class="footer-bottom-right">&copy; 2021 E-Catering. All Rights Reserved |  </p>
		<div class="clearfix"></div>
	</div>
</div>
